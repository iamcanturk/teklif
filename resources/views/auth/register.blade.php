                            ...
                            <form action="{{route('register')}}" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control pl-15 bg-transparent text-white plc-white @error('name') is-invalid @enderror "  value="{{old('name')}}" placeholder="Ad">
                                    </div>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="lastname" id="lastname" class="form-control pl-15 bg-transparent text-white plc-white  @error('lastname') is-invalid @enderror " value="{{old('lastname')}}" placeholder="Soyad">
                                    </div>
                                    @error('lastname')
                                    <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password"  name="password_confirmation"  id="password_confirmation" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Parola Tekrarı">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
