							...
							<input type="file">
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body bb-1 border-fade">
                                        <p class="lead">Authoritatively syndicate goal-oriented leadership skills for
                                            clicks-and-mortar outsourcing. Synergistically reconceptualize enabled
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p>
                                                    ...
                                                    <time class="float-right text-fade" datetime="2017-07-14 20:00">Just
                                                        now
                                                    </time>
                                                </p>
                                                ...
                                                <div class="media px-0 mt-20">
                                                    ...
                                                    <div class="media-body">
                                                        <p>
                                                            ...
                                                            <time class="float-right text-fade"
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p>
                                                    ...
                                                    <time class="float-right text-fade" datetime="2017-07-14 20:00">2
                                                        hours ago
                                                    </time>
                                                </p>
                                                <p>Continually drive user friendly solutions through performance based
                                                    infomediaries.</p>
                                            </div>
                                        </div>
                                    </div>
							...
							<span class="timeline-label">
								<span class="badge badge-info badge-pill">Images</span>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-event">
                                                <div class="timeline-heading">
                                                    <h4 class="timeline-title"><a href="#">Jone Doe</a><small> commented
                                                            on your post</small></h4>
                                                </div>
                                                <div class="timeline-body">
                                                ...
                                                <div class="timeline-footer">
                                                    <a class="btn btn-rounded btn-success btn-sm" href="#">View
                                                        comment</a>
                                        ...
                                        <div class="activitytimeline">
                                            ...
                                            <form class="form-horizontal form-element">
                                                <div class="form-group row no-gutters">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <button type="submit"
                                                                class="btn btn-rounded btn-danger pull-right btn-block btn-sm">
                                                            Send
                                                        </button>
                                                    </div>
                                                </div>
